<div class="header">
		<div class="header_left">
			<ul>
				<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Bangalore</li>
				<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>+91 9347228700</li>
			</ul>
		</div>
